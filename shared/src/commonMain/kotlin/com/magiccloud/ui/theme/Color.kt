...
val md_theme_light_primary = Color(0xFFFFFFFF) // 白色
val md_theme_light_onPrimary = Color(0xFF1C1B1B) // 黑色
val md_theme_light_primaryContainer = Color(0xFF38A6E8) // 淡蓝色
val md_theme_light_onPrimaryContainer = Color(0xFFFFFFFF)
val md_theme_light_secondary = Color(0xFFFFFFFF)
val md_theme_light_onSecondary = Color(0xFF1C1B1B)
val md_theme_light_secondaryContainer = Color(0xFFF1F1F5)
val md_theme_light_onSecondaryContainer = Color(0xFF1C1B1B)
val md_theme_light_tertiary = Color(0xFFF1F1F5)
val md_theme_light_onTertiary = Color(0xFF8B8A96)
...
val md_theme_light_background = Color(0xFFF1F1F5)
val md_theme_light_onBackground = Color(0xFF201A1B)
val md_theme_light_surface = Color(0xFFF1F1F5)
